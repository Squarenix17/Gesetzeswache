 ...
 *
 * Compatible with Cursor's existing hook events:
...
// Cursor's stored OAuth bearer token. Treat auth-gated responses as
...
function stateFilePath() {
  ...
  return path.join(os.homedir(), '.cursor', 'mcp-health-cache.json');
}
