...
description: "Patterns and architectures for autonomous Cursor loops — from simple sequential pipelines to RFC-driven multi-agent DAG systems."
metadata:
  origin: ECC
---
...
echo "Focus areas: auth module, API rate limiting" > .cursor-context.md
cursor agent -p "Read .cursor-context.md for priorities. Work through them in order."
rm .cursor-context.md
```
...
Create `.cursor/commands/infinite.md`:
