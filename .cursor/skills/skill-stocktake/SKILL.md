...
**Results cache:** `~/.cursor/skills/skill-stocktake/results.json`

## Quick Scan Flow

Re-evaluate only skills that have changed since the last run (5–10 min).

1. Read `~/.cursor/skills/skill-stocktake/results.json`
2. Run: `bash ~/.cursor/skills/skill-stocktake/scripts/quick-diff.sh \
         ~/.cursor/skills/skill-stocktake/results.json`
...
7. Run: `bash ~/.cursor/skills/skill-stocktake/scripts/save-results.sh \
         ~/.cursor/skills/skill-stocktake/results.json <<< "$EVAL_RESULTS"`

## Full Stocktake Flow

### Phase 1 — Inventory

Run: `bash ~/.cursor/skills/skill-stocktake/scripts/scan.sh`
