...
Install: cp this file to ~/.cursor/scripts/quality-gate.py
...
def get_project_memory_dir() -> Optional[str]:
    ...
    mem = os.path.expanduser(f'~/.cursor/projects/{safe}/memory')
...
def main() -> None:
    ...
    # Cursor reads stderr as the hook's response message.
