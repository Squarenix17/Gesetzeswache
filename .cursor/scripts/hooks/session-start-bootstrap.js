 ...
 * "SessionStart:startup hook error" to appear in the Cursor CLI header.
 *
 ...
 *
 * How it works:
 *   1. Reads the raw JSON event from stdin (passed by Cursor).
 ...
 *      through unchanged so Cursor can continue normally.
 */
