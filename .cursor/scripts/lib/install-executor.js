...
const EXCLUDED_GENERATED_SOURCE_SUFFIXES = ['/install-state.json', '/ecc/install-state.json'];
...
function addCursorAgentDataScaffoldOperations(operations, options) {
  ...
  addFileCopyOperation(operations, {
    ...
    sourceRelativePath: path.join('scaffolds', 'cursor', 'agent-data.json'),
    destinationPath: path.join(options.targetRoot, 'agent-data.json'),
  ...
  addFileCopyOperation(operations, {
    moduleId: options.moduleId,
    sourceRoot: options.sourceRoot,
    sourceRelativePath: path.join('scaffolds', 'cursor', 'rules', 'agent-data-home.mdc'),
    destinationPath: path.join(options.targetRoot, 'rules', 'agent-data-home.mdc'),
    strategy: 'preserve-relative-path'
  });
