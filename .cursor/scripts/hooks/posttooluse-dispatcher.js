...
const { run: runMetricsBridge } = require('./metrics-bridge');
const { run: runContextMonitor } = require('./context-monitor');
...
const SYNC_HOOKS = [
  ...
  { id: 'post:metrics-bridge', matcher: '*', profiles: 'minimal,standard,strict', script: 'scripts/hooks/metrics-bridge.js', run: runMetricsBridge },
  { id: 'post:context-monitor', matcher: '*', profiles: 'standard,strict', script: 'scripts/hooks/context-monitor.js', run: runContextMonitor }
];
