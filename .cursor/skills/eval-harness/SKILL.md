---
name: eval-harness
description: Formal evaluation framework for Cursor sessions implementing eval-driven development (EDD) principles
metadata:
  origin: ECC
...
A formal evaluation framework for Cursor sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for Cursor task completion
...
- `.cursor/evals/<feature>.md` definition
- `.cursor/evals/<feature>.log` run history
