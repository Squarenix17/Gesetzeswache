...
#
# Environment:
#   RULES_DISTILL_GLOBAL_DIR   Override ~/.cursor/skills (for testing only;
#                              do not set in production — intended for bats tests)
#   RULES_DISTILL_PROJECT_DIR  Override project dir detection (for testing only)

set -euo pipefail

GLOBAL_DIR="${RULES_DISTILL_GLOBAL_DIR:-$HOME/.cursor/skills}"
CWD_SKILLS_DIR="${RULES_DISTILL_PROJECT_DIR:-${1:-$PWD/.cursor/skills}}"
