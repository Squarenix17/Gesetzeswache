...
func Load() (Config, error) {
	...
	for _, u := range []struct {
		...
		{"GEW_GII_BASE", c.GIIBase},
		{"GEW_GII_TOC_URL", c.GIITOCURL},
		{"GEW_GII_FEED_URL", c.GIIFeedURL},
		{"GEW_BGBL_FEED1_URL", c.BGBlFeed1URL},
		{"GEW_BGBL_FEED2_URL", c.BGBlFeed2URL},
		{"GEW_ELI_BASE", c.ELIBase},
	} {
		if err := httpx.ValidateURL(u.url); err != nil {
			return c, fmt.Errorf("invalid %s: %w", u.name, err)
		}
	}
	return c, nil
}
