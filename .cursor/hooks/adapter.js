...
/**
 * Cursor hook adapter
 * Normalizes Cursor hook stdin JSON into the legacy ECC hook payload shape,
 * then delegates to existing scripts/hooks/*.js implementations.
 */
...
function transformToLegacyHook(cursorInput, overrides = {}) {
  return {
    tool_input: {
