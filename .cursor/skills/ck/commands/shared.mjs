...
export const CK_HOME          = resolve(homedir(), '.cursor', 'ck');
...
export const SKILL_FILE       = resolve(homedir(), '.cursor', 'skills', 'ck', 'SKILL.md');
...
export function nativeMemoryDir(absolutePath) {
  ...
  return resolve(homedir(), '.cursor', 'projects', encoded, 'memory');
}
