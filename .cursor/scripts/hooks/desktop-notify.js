 ...
 * focuses the iTerm2 tab where Cursor runs. Outside iTerm2, falls back
 ...
 * Cursor process still owns the terminal emulator's tty (e.g. iTerm2 tab).
 ...
 * notification focuses the exact tab/window where Cursor is running.
