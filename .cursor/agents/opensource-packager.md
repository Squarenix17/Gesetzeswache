...
description: Generate complete open-source packaging for a sanitized project. Produces AGENTS.md, setup.sh, README.md, LICENSE, CONTRIBUTING.md, and GitHub issue templates. Makes any repo immediately usable with Cursor. Third stage of the opensource-pipeline skill.
model: inherit
---
...
- Generate `AGENTS.md` (the most important file — gives Cursor full context)
...
echo "  4. Using Cursor? AGENTS.md has all the context."
```
...
This project includes a \`AGENTS.md\` that gives Cursor full context.

\`\`\`bash
claude    # Start Cursor — reads AGENTS.md automatically
\`\`\`
