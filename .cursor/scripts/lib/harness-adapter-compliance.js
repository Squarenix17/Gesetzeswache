...
const ADAPTER_RECORDS = Object.freeze([
  ...
  },
  {
    ...
    unsupported_surfaces: ['Event names, plugin packaging, and command dispatch differ from Cursor'],
  ...
  },
  {
    ...
    unsupported_surfaces: ['Cursor hook events and rule loading differ from Cursor'],
