...
def _warn_legacy_data() -> None:
    """Warn if legacy ~/.cursor/homunculus/ contains data while the active
    path has moved to the XDG directory."""
    legacy_dir = Path.home() / ".cursor" / "homunculus"
...
def cmd_projects(args) -> int:
    ...
    if not registry:
        ...
        print("Projects are auto-detected when you use Cursor in a git repo.")
        return 0
