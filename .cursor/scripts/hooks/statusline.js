 ...
 * Reads bridge file from metrics-bridge.js and stdin from Cursor runtime.
 */
 ...
 * @param {number} remaining - Raw remaining percentage from Cursor
...
function readCurrentTask(sessionId) {
  try {
    ...
    const todosDir = path.join(cursorDir, 'todos');
