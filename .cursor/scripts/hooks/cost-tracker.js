 ...
 * days). The fix is to read the transcript file Cursor already passes us.
 *
 * JSONL assistant entry shape (per Cursor):
 ...
 *   from Cursor) writes `{ts, cost_usd}` to
